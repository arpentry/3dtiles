...
export const TEST_ELEVATION_PATH = join(process.cwd(), 'public', 'swissalti3d_web_mercator_test.tif')
export const TEST_TEXTURE_PATH = join(process.cwd(), 'public', 'swissimage_web_mercator_test.tif')

// Test data URLs that will be mocked
export const TEST_ELEVATION_URL = 'http://localhost:8787/swissalti3d/swissalti3d_web_mercator.tif'
export const TEST_TEXTURE_URL = 'http://localhost:8787/swissimage-dop10/swissimage_web_mercator.tif'
